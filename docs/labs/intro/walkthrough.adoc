...
The Camel source definition would define the entire end to end processing logic, which you can find in your project explorer here:

image::images/00-camel-routes.png[align="left", width=40%]
...
[source, subs=]
----
cd /projects/devsandbox-camel-sb-simple/level1simple/<br>
----
+
{blank}
+
...
+
test1: {openshift-host}
+ 
test2: {user-username}
+
test3: {openshift-app-host}
+
test4: {username} 
+
[source, subs=]
